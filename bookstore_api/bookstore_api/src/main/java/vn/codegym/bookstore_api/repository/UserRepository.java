...
public interface UserRepository extends JpaRepository<AppUser, Integer> {
    ...
    @Modifying
    @Query(value = "insert into app_user (username, `password`, creation_date, is_deleted) values (:username, :password, current_date(), 0)", nativeQuery = true)
    ...
    @Modifying
    @Query(value = "update app_user set username = :username, `password` = :password where id = :id", nativeQuery = true)
